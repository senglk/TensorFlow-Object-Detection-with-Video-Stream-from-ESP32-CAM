# Code base from https://github.com/sglvladi/TensorFlowObjectDetectionTutorial
# Edited version to work with HTTP Multipart MJPEG
# Run from /TensorFlow/models/research/object_detection
...
# Uncomment the following if script hangs after executing a few frames!
